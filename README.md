...
The review proposes a layered inferential process, combining multisensory integration, causal inference, and perception of contingency. This experiment questions this proposed mechanism, by hypothesising that contingency is encoded through statistical learning within its environment : what properties co-occur reliably with self-indexed causality? When does the agent hold a distinct position in the causal network it observes? 
